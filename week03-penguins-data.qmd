...
```{r, message=FALSE, warning=FALSE}
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.25) + # Alpha is transparency
  scale_fill_manual(values = c("darkorange", "darkorchid", "cyan4")) + #manual colors
  theme_bw() +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archepelago",
       x = "Flipper Length (mm)",
...
```{r, message=FALSE}
ggplot(data = penguins_data, aes(x = flipper_length_mm, fill = species)) +
  geom_histogram(alpha = 0.99) + # Alpha is transparency
  scale_fill_viridis_d(option = c("magma", name = "Penguin Species"))
  theme_bw() +
  labs(title = "Palmer Penguins' Flipper Length",
       subtitle = "Three species observed on three islands in the Palmer Archepelago",
       x = "Flipper Length (mm)",
...
ggplot(data = penguins_data, aes(x = flipper_length_mm, y = body_mass_g, color = species, shape = island)) +
  geom_point() +
  scale_shape_manual(values = c(11,14,13))
...
plotname <- ggplot(data = penguins_data, aes(x = culmen_depth_mm, fill = species)) + 
  geom_histogram() +
  theme_bw() +
  scale_fill_viridis_d(option = ("darkorange")) +
