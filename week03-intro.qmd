...
mtcars <- mtcars |> # shift control M = |> 
  rownames_to_column("m0del")

view(mtcars)
head(mtcars, 4) # preview
  
summary(mtcars)

?mtcars # opens helpful info
...
- Some variables I see are mpg, cyl, disp, hp, drat, wt, qsec, vs, am, gear, and carb.
...
mean(mtcars$mpg) # $ lets you select a variable column within dataframe.
...
ggplot(data = mtcars, aes(x = wt, y = mpg)) +
  geom_point() #geom_point gives the plot geometry
